...
public class SimpleChatClient {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            logger.info("[CLIENT]Attempting to connect to the server at localhost:5000...");
            ...
            logger.info("[CLIENT]Retrieving input stream...");
            InputStream inputStream = socket.getInputStream();
            logger.info("[CLIENT]Input stream successfully retrieved.");

            /* **Get the output stream of the socket. This stream is used to send data to the server.** */
            logger.info("[CLIENT]Retrieving output stream...");
            OutputStream outputStream = socket.getOutputStream();
            logger.info("[CLIENT]Output stream successfully retrieved.");
            ...
            logger.info("[CLIENT]Initializing scanner for user input...");
            Scanner scanner = new Scanner(System.in);
            logger.info("[CLIENT]Scanner initialized successfully.");

            /* **Enter an infinite loop where the client will continuously send messages to the server and receive responses.** */
            while (true) {

                /* **Prompt the user to enter a message.** */
                logger.info("[CLIENT]Prompting user for input...");
                System.out.print("You: ");

                /* **Read a line of input from the user.** */
                String message = scanner.nextLine();
                logger.info("[CLIENT]User input received: " + message);
                ...
                logger.info("[CLIENT]Message sent successfully.");
                ...
                logger.info("[CLIENT]Response received from server.");
                ...
                logger.info("[CLIENT]Server response processed: " + responseMessage);

                /* **Print the server's response to the console.** */
                System.out.println("[CLIENT]Server: " + responseMessage);
            }
        ...
        /* **Catch any IOException that may occur and print the stack trace. 
            ...
            logger.log(Level.SEVERE, "[CLIENT]SocketException occurred!", e);
        } catch (SocketTimeoutException e) {
            logger.log(Level.SEVERE, "[CLIENT]SocketTimeoutException occurred!", e);
        } catch (IllegalBlockingModeException e) {
            logger.log(Level.SEVERE, "[CLIENT]IllegalBlockingModeException occurred!", e);
        } catch (SecurityException e) {
            logger.log(Level.SEVERE, "[CLIENT]SecurityException occurred!", e);
        } catch (IOException e) {
